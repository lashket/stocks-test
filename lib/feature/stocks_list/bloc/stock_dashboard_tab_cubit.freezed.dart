...
part of 'stock_dashboard_tab_cubit.dart';
...
mixin _$DashboardState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int totalItems) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int totalItems)? loaded,
...
class _$DashboardLoadedImpl implements DashboardLoaded {
  const _$DashboardLoadedImpl({required this.totalItems});
  ...
  @override
  String toString() {
    return 'DashboardState.loaded(totalItems: $totalItems)';
  }
...
abstract class DashboardLoaded implements DashboardState {
  const factory DashboardLoaded({required final int totalItems}) =
...
class _$DashboardErrorImpl implements DashboardError {
  const _$DashboardErrorImpl(this.error);
...
abstract class DashboardError implements DashboardState {
  const factory DashboardError(final DomainError error) = _$DashboardErrorImpl;
